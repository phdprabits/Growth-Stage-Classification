...
if __name__ == '__main__':
    ...
    dataset_file =  'cotton_data20182019sync.csv'  
    train_cols = ['Plot_ID', 'Date', 'stage', 'B2', 'B3', 'B4', 'RE1', 'RE2', 'RE3', 'NIR', 'RE4', 'SWIR1', 'SWIR2', 'VV', 'VH'] 
    #train_cols = ['Plot_ID', 'Date', 'VH', 'VV']         
    target_col = 'stage'
    id_col = 'Plot_ID'   
    rand_seed = 101
    ...
    #min(data.train_set['stage'].value_counts())
    ...
    feat_dataset_file ='Balanced_data_featuredata_cotton.xlsx' 
